...
export function useAllProposalData(): { data: ProposalData[]; loading: boolean } {
  ...
  const proposalsV0 = useSingleContractMultipleData(gov0, 'proposals', gov0ProposalIndexes, undefined)
  const proposalsV1 = useSingleContractMultipleData(gov1, 'proposals', gov1ProposalIndexes, undefined)
  const proposalsV2 = useSingleContractMultipleData(gov2, 'proposals', gov2ProposalIndexes, undefined)

  // get all proposal states
  const proposalStatesV0 = useSingleContractMultipleData(gov0, 'state', gov0ProposalIndexes, undefined)
  const proposalStatesV1 = useSingleContractMultipleData(gov1, 'state', gov1ProposalIndexes, undefined)
  const proposalStatesV2 = useSingleContractMultipleData(gov2, 'state', gov2ProposalIndexes, undefined)
